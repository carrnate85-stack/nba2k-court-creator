  ...
  <div id="layout">
    ...
    <aside>
      ...
      <section class="section" id="inspector" hidden>
        ...
        <div class="row"><button id="visible">Hide</button><button id="lockScale">Unlock Scale</button></div>
        <div class="row"><button id="copyX">Copy Across X</button><button id="copyY">Copy Across Y</button></div>
        <div class="row"><button id="flipX">Flip H</button><button id="flipY">Flip V</button></div>
            ...
            items.append(
                {
                    ...
                    "scaleLocked": bool(item.get("scaleLocked", True)),
